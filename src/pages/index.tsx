...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Eternal AI Chat v2`}</title>

        <meta
          name="description"
          content="Experience seamless AI interactions with Eternal AI Chat v2. Log in to explore, engage, and evolve your chats. Your personalized AI communication hub awaits."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless AI interactions with Eternal AI Chat v2. Log in to explore, engage, and evolve your chats. Your personalized AI communication hub awaits.`}
            </Text>
            <Box
